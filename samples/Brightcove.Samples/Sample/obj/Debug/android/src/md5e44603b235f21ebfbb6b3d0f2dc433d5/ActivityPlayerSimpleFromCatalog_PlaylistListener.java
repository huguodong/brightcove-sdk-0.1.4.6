		...
		com.brightcove.player.media.ErrorListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Sample.ActivityPlayerSimpleFromCatalog+PlaylistListener, Sample, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ActivityPlayerSimpleFromCatalog_PlaylistListener.class, __md_methods);
	}
	...
	public ActivityPlayerSimpleFromCatalog_PlaylistListener () throws java.lang.Throwable
	{
		...
		if (getClass () == ActivityPlayerSimpleFromCatalog_PlaylistListener.class)
			mono.android.TypeManager.Activate ("Sample.ActivityPlayerSimpleFromCatalog+PlaylistListener, Sample, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
